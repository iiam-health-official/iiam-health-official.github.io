      ...
      <div className="w-full relative flex flex-col items-center justify-start py-[54px] text-[36px] pt-[100px] px-5 box-border gap-[57px] tracking-[normal] mq750:gap-[28px]">
        ...
        <section className="self-stretch overflow-hidden flex flex-row flex-wrap items-start justify-center p-[30px] box-border gap-[90px] max-w-full mq450:pt-5 mq450:pb-5 mq450:box-border mq750:gap-[22px] mq750:pl-9 mq750:pr-9 mq750:box-border mq1125:gap-[45px] mq1125:pl-[72px] mq1125:pr-[72px] mq1125:box-border">
          <NewsArticle
            ...
            Head and Neck is an internationally regarded peer-reviewed journal dedicated to publishing research in the diagnosis and management of head and neck diseases. In this study, the team demonstrates how machine learning modeling accurately predicts head and neck cancer surgery recommendations based on patient and cancer information from a large population-based dataset. Machine learning adjuncts for referral processing also decrease the time to treatment for patients with cancer.
            "
          />
          <NewsArticle
            Logo="/avater-02@2x.png"
